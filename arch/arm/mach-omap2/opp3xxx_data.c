...
#define AM33XX_ES2_1_VDD_MPU_OPPNITRO_UV	1350000

#define OPP_50_INDEX		0
#define OPP_100_INDEX		1
#define OPP_TURBO_INDEX		2
#define OPP_NITRO_INDEX		3
...
/*
 * Bits [17-16] indicates package type
 * 00 - reserved
 * 01 - ZCZ
 * 10 - ZCE
 * 11 - reserved
 */
#define PACKAGE_TYPE_MASK	0x3
#define PACKAGE_TYPE_SHFT	16
...
#define OPP_50_300MHZ_ZCZ_BIT		4
#define OPP_100_600MHZ_ZCZ_BIT		6
#define OPP_TURBO_800MHZ_ZCZ_BIT	8
#define OPP_NITRO_1GHZ_ZCZ_BIT		9

#define OPP_50_300MHZ_ZCE_BIT		5
#define OPP_100_600MHZ_ZCE_BIT		6
...
{
	int r = -ENODEV;
	u32 rev, val, package_type, max_freq;
	...
	if (cpu_is_omap3630())
		...
		case AM335X_REV_ES2_1:
			...
			package_type = (val >> PACKAGE_TYPE_SHFT) &
							PACKAGE_TYPE_MASK;
			max_freq = val & MAX_FREQ_MASK;

			if (package_type == PACKAGE_TYPE_ZCZ) {
				if (max_freq & OPP_50_300MHZ_ZCZ_BIT)
					am33xx_es2_1_opp_list[OPP_50_INDEX].
						default_available = true;

				if (max_freq & OPP_100_600MHZ_ZCZ_BIT)
					am33xx_es2_1_opp_list[OPP_100_INDEX].
						default_available = true;

				if (max_freq & OPP_TURBO_800MHZ_ZCZ_BIT)
					am33xx_es2_1_opp_list[OPP_TURBO_INDEX].
						default_available = true;

				if (max_freq & OPP_NITRO_1GHZ_ZCZ_BIT)
					am33xx_es2_1_opp_list[OPP_NITRO_INDEX].
						default_available = true;
			} else if (package_type == PACKAGE_TYPE_ZCE) {
				if (max_freq & OPP_50_300MHZ_ZCE_BIT)
					am33xx_es2_1_opp_list[OPP_50_INDEX].
						default_available = true;

				if (max_freq & OPP_100_600MHZ_ZCE_BIT)
					am33xx_es2_1_opp_list[OPP_100_INDEX].
						default_available = true;
			} else {
				/*
				* if package type is not detected fall back to
				* PG 2.0 OPP settings
				*/
				r =
